...
- Added datetime usage guidelines: avoid deprecated `datetime.utcnow()`
- Recommended `datetime.now(timezone.utc)` as the correct approach

## [1.1.2] - 2026-07-08

### Changed

- Skill files now bundled in npm package, no more git clone
- Installation works offline without GitHub access
